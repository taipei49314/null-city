...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@null-city/test-fixtures": fileURLToPath(new URL("../test-fixtures/src/index.ts", import.meta.url)),
      "@null-city/scenario-schema": fileURLToPath(new URL("./src/index.ts", import.meta.url)),
    },
  },
  test: {
